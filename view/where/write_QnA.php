...
<h3 align=center>질문 작성하기</h3>


<!-- Container -->
<div class="ui container" style="padding:20px; width:700px" align=center >

<form class="ui form" method="post" action="./post/write_QnA_action.php">  
<!-- dropdown -->
...
<div class="field">
    ...
    <input type="text" maxlength="75" name="title" placeholder="내용을 쉽게 알수있도록 질문을 입력해주세요">
</div>
