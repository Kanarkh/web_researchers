<?php
    ...
    if($total==1){
        if($rows['refortnum']==0){
            ...
            $query = "update qnaboard set whorefort = '$emailRefort', refortnum=1 where number=$number";
            $result = $connect->query($query);
            ...
            if($refortState==0){
                ...
                $query = "update qnaboard set whorefort = '$emailRefort', refortnum=$num where number=$number";
                $result = $connect->query($query);
